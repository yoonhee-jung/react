...
function App() {
  ...
  return (
    ...
    {/* 과제 : 웹페이지 최상단에 10 이상이면 숫자 표시, 10 이하면 숫자 표시 안 되게. */}
    
    <p>{ count.valueOf() >= 10 ? count.valueOf() : null }</p>
    {/* <p>{ count.valueOf() >= 10 && count.valueOf() }</p> */}
    ...
    <br />
    <br />
    <input type="text" value={account} onChange={(e) => {setAccount(e.target.value)}} name="" id="" />
    <p>{count}</p>
